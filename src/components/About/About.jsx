    ...
    >
      <div className='container'>
        <div className='bg-zinc-800/50 p-7 rounded-2xl md:p-12'>
          ...
          <br/>
          Currently, I am expanding my skill set to include backend development, aiming to become a proficient MERN Stack Developer. I'm excited about the opportunities this transition brings, allowing me to create full-stack applications and enhance user experiences from both ends.
          </p>
        </div>
      </div>
    </section>
